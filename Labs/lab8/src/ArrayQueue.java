...
public class ArrayQueue<E> implements Queue<E> {
    ...
    public void enqueue( E elem ) {
        ...
        // pre-condition: ???
    	if(isFull()) {
    		 System.out.println("ca ajoute premier if ");
    		try{
            ...
            // YOUR CODE HERE
            	...
            	System.out.println("ca attrape array bound");
            	
    	}}

        if ( rear == ( MAX_QUEUE_SIZE -1 ) ) {
        	 System.out.println("ca ajoute deuxiemme if ");
    ...
    public E dequeue() {
        ...
        // pre-condition: ???
    	System.out.println("ca de queue");
    	if(isEmpty()) {
    		try {
    			 E saved = elems[ front ];
